  ...
  return (
    <header className="w-full max-w-2xl mx-auto px-4 py-3.5 flex items-center justify-between border-b border-surfaceBorder select-none">
      ...
      <div className="flex items-center gap-2">
        ...
        {roundInfo && (
          <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-surfaceRaised border border-surfaceBorder text-accent font-semibold">
            {roundInfo}
          </span>
        )}
      </div>
      ...
      <div className="flex items-center gap-2 font-mono text-xs">
        <div
          className="flex items-center gap-1.5 bg-surfaceRaised border border-surfaceBorder px-2.5 py-1 rounded-md text-zinc-200 font-semibold"
          title="Total Score"
        >
